  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 sm:items-center">
        <div className="relative flex size-6 shrink-0 items-center justify-center select-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:text-muted-foreground [&_svg:not([class*='size-'])]:size-5">
          {experience.companyLogo ? (
            <Image
              ...
              quality={100}
              className={cn(
                "rounded-full grayscale transition-[filter,opacity] duration-300 ease-[cubic-bezier(0.42,0,0.58,1)] group-hover/experience:grayscale-0",
                experience.id === "ibm-rooman" &&
                  "group-hover/experience:opacity-0"
              )}
              unoptimized
              aria-hidden
            />
          ...
          {experience.id === "ibm-rooman" && (
            <IBMBee className="absolute inset-0 size-6 opacity-0 transition-opacity duration-300 ease-out group-hover/experience:opacity-100" />
          )}
        </div>
