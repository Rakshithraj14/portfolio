...
// would read `localhost` in dev. Falls back to the raw string if `USER.website`
// isn't a valid absolute URL yet (e.g. still a placeholder).
const SITE_TITLE = (() => {
  try {
    return new URL(USER.website).host
  } catch {
    return USER.website
  }
})()
